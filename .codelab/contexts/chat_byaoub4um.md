# ESTADO: Paso 2 de varios.
**EXPLICACIÓN**: Hemos creado una carpeta separada para el proyecto y organizado la estructura de archivos para el proyecto de aplicación web con Express.js, incorporando helmet y cors para mejorar la seguridad.
**ACCIÓN**:
```javascript
