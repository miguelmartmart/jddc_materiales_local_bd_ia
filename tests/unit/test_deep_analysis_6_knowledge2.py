...
class TestPhase2KnowledgeStoreCache:
    ...
    def test_cache_hit_skips_sql_queries(self):
        """Con cache fresco, no se ejecutan queries a la BD."""
        from datetime import datetime, timedelta
        agent = make_agent()
        # BD que lanzaría excepción si se consulta
        agent.sql_executor = MagicMock(side_effect=Exception("NO DEBERÍA LLAMARSE"))
    ...
    def test_cache_miss_executes_sql(self):
    ...
    def test_stale_cache_re_explores(self):
    ...
    def test_cache_hit_restores_tipo_distribution(self):
    ...
    def test_cache_no_crash_on_store_error(self):
