...
BASE_CONCEPT_INDEX = {
    ...
    "instalacion": [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "obra":        [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "mantenimiento":[{"table": "DOCCAB", "filter": "TIPO=10"},{"table": "DOCLIN"}],
    # ── Análisis de conversión / tasa de éxito ────────────────────────────────
    # CRÍTICO: estas keywords permiten calcular tasa de éxito de presupuestos
    # DOCDESTINO vincula presupuesto (TIPO=0) → pedido/albarán/factura
    "tasa":        [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "exito":       [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "aceptado":    [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "conversion":  [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "convertido":  [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "convierten":  [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "porcentaje":  [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "aprobado":    [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "rechazado":   [{"table": "DOCCAB", "filter": "TIPO=0"},  {"table": "DOCDESTINO"}],
    "pendiente":   [{"table": "DOCCAB"},                      {"table": "DOCDESTINO"}],
    "docdestino":  [{"table": "DOCDESTINO"},                  {"table": "DOCCAB"}],
